    ...
    <>
      <div className="max-w-5xl mx-auto pb-10 bg-[#1d2d44]" id="contact">
        ...
        <p className=" text-xs">
          ...
          used to enhance our model. While we strive for accuracy, our model's
          output is not guaranteed to be 100% correct. We recommend consulting
          with an expert before relying on our results.
        </p>
      </div>
    </>
  );
