...
// Full sentence replacement
  ...
  result = result.replaceAll('བོད་དབུས་སྲིད་གཞུང་གི་', 'བོད་མིའི་སྒྲིག་འཛུགས་ཀྱི་');
  ...
  result = result.replaceAll("ཀྲུང་གུང་ཀྲུང་དབྱང་","རྒྱ་ནག་དབུས་དམར་ཤོག་གཞུང་");
  ...
  result = result.replaceAll("བོད་ཀྱི་གཙུག་ལག་གཅེས་བཏུས་པོད་ཕྲེང་ཉི་ཤུ་རྩ་བརྒྱད་པ་སྨན་གཞུང་།", "བོད་ཀྱི་སྲིད་བཤུས་ཉམས་ཞིབ་ཁང་།");
