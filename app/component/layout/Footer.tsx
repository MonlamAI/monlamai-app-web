...
function Footer() {
  ...
  return (
    <footer
      ...
      } bottom-0 w-full p-3 bg-primary-100 dark:bg-secondary-800 text-light_text-secondary dark:text-dark_text-secondary shadow-md dark:shadow-none transition-all duration-500 `}
      style={{
