...
export function CancelButton(props: any) {
  return (
    <div
      className="absolute z-20 -top-1 -right-2 text-neutral-500 hover:text-neutral-800 hover:bg-neutral-100 transition-colors duration-200 rounded-md p-1 cursor-pointer"
      {...props}
      title="reset"
    >
      {props.children}
