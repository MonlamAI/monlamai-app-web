...
function Privacy_policy() {
    const markdown=`
   Privacy Policy for Lamdre Dictionary
Last Updated: 16/10/2024

Introduction
Lamdre Dictionary ("we," "us," or "our") respects your privacy and is committed to protecting your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you use our mobile application, Lamdre Dictionary ("the App"), available on Android and iOS platforms.
...
Address: Lamdre Dictionary, Jogiwara Rd, near Tibetan Mentsee Khang, Upmuhal, Dharamshala, Himachal Pradesh 176215

12. Consent
By using the App, you consent to our collection and use of your information as described in this Privacy Policy.

13. Permissions
The App may request certain permissions to enhance user experience:

Internet Access: To access online dictionary resources and updates.
Storage: To store language files and offline data.
...
We do not use cookies within the App. However, any integrated third-party services may use cookies per their policies.

16. Advertising
We do not display third-party advertisements within the App.

17. External Links
The App may contain links to external websites or resources. We are not responsible for the privacy practices or content of these external sites.

18. Dispute Resolution
Any disputes arising from this Privacy Policy will be resolved through binding arbitration per [Applicable Law/Arbitration Rules].

This policy provides a straightforward overview of data practices for the Lamdre Dictionary app, with privacy, security, and user rights prioritized.
`
