...
function TextComponent({ sourceText, setSourceText, sourceLang }) {
  ...
  return (
    <Textarea
      ...
      className={`w-full overflow-auto resize-none flex-1 min-h-[5em] bg-transparent p-2 border-0 focus:outline-none focus:ring-transparent  caret-slate-500 placeholder:text-slate-300 placeholder:font-monlam placeholder:text-lg ${
